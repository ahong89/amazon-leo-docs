...
# Intro
This is a document which contains all the current guidelines for contributing to the **Amazon Leo
Team** with App Dev Club. It is subject to change over the course of the semester and everyone is
highly encouraged to reference the document as needed.

Excerpt from the PEP 8 style guide:
